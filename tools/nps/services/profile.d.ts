...
export declare function populateGameProfiles(profiles: GameProfile[]): Promise<void>;
export declare function getGameProfilesForCustomerId(customerId: number): Promise<GameProfile[]>;
export declare function gameProfileExists(profileName: string): Promise<boolean>;
