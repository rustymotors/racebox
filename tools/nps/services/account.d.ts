...
export declare function getCustomerId(username: string): Promise<number | undefined>;
export declare function checkPassword(user: User, password: string): Promise<boolean>;
