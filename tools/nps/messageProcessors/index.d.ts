...
export type MessageProcessor = (connectionId: string, message: GameMessage, socketCallback: SocketCallback) => Promise<void>;
...
export declare function populateGameMessageProcessors(processors: Map<number, MessageProcessor>): void;
export declare function getGameMessageProcessor(messageId: number): MessageProcessor;
...
export declare function populatePortToMessageTypes(portMap: Map<number, string>): void;
