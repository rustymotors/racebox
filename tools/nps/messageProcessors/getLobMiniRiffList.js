...
// Command id: 0x30c
export async function getLobMiniRiffList(commandId, data) {
    ...
    log.info(`responseMessage: ${responseMessage.serialize().length} bytes - ${getAsHex(responseMessage.serialize())}`);
